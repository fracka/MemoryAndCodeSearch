...
#### UI not working on http://localhost:3001?

If the UI does not start properly on http://localhost:3001, try running it manually:
...
The OpenMemory dashboard will be available at http://localhost:3001. From here, you can view and manage your memories, as well as check connection status with your MCP clients.
